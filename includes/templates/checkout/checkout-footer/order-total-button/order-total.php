...
<div class="wps-deals-cart-purchase-total">
	<?php echo apply_filters( 'wps_deals_cart_order_total',__('Order Total : ','wpsdeals').'<span class="wps_deals_cart_total">'.$wps_deals_currency->wps_deals_formatted_value( $cartdata['total'] ),$wps_deals_currency->wps_deals_formatted_value( $cartdata['total'] ));?></span>
</div>