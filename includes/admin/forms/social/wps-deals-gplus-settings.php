						...
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									...
									<input type="text" name="wps_deals_options[gplus_icon_url]" id="wps_deals_gplus_icon_url" value="<?php echo $model->wps_deals_escape_attr( $wps_deals_options['gplus_icon_url'] ); ?>" wps-deals-img-upload-input />
